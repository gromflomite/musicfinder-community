        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtistImage = table.Column<string>(maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlbumNumberOfSongs = table.Column<int>(maxLength: 2, nullable: true),
                    AlbumReleaseDate = table.Column<DateTime>(nullable: true),
                    AlbumImage = table.Column<string>(maxLength: 50, nullable: true),
                    AlbumComments = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
